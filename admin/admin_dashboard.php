...
<script>
  ...
  new Chart(barCtx, {
    type: 'bar',
    data: {
      labels: ['Users', 'Timesheets', 'Claims', 'Leaves'],
      datasets: [
        { label: 'Active', data: [34, 12, 8, 7], backgroundColor: '#36a2eb' }
      ]
    },
    options: {
      responsive: true,
