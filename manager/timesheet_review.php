...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['timesheet_id'], $_POST['action'])) {
    ...
    $stmt->execute([$new_status, $timesheet_id]);
}

// Fetch all pending timesheets and associated employee info
$stmt = $pdo->query("
...
<div class="container-fluid p-0">
  <div class="row g-0">
    ...
    <div class="main-content col">
      ...
      <div class="card">
        <div class="card-header bg-primary text-white">Pending Timesheets</div>
            ...
            <table class="table table-hover mb-0">
                ...
                <?php foreach ($timesheets as $ts): ?>
                    <tr>
                        ...
                        <td>
                            <button type="button"
                              class="btn btn-sm btn-secondary mb-1 view-details-btn"
                            ...
                            <form method="post" class="d-inline">
                                ...
                                <button type="submit" name="action" value="approved" class="btn btn-sm btn-success mb-1">Approve</button>
                                <button type="submit" name="action" value="rejected" class="btn btn-sm btn-danger mb-1">Reject</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if (empty($timesheets)): ?>
                    <tr><td colspan="6" class="text-center">No pending timesheets for review.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<script>
// Trigger AJAX fetch for details
