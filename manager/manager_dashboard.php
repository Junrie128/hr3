...
<head>
    <meta charset="UTF-8">
    <title>HR Manager Dashboard - ViaHale TNVS HR3</title>
    ...
    <div class="main-content col" style="margin-left:220px;">
      ...
      <div class="stats-cards">
        ...
        <div class="stats-card">
          ...
          <div class="label">Escalated Claims</div>
          <div class="value">2</div>
        </div>
        <div class="stats-card">
          <div class="icon"><ion-icon name="calendar-outline"></ion-icon></div>
          <div class="label">Schedules (View Only)</div>
          <div class="value">5</div>
        </div>
      </div>
      <div class="dashboard-row">
        <div class="dashboard-col" style="flex:1.7">
          <h5>Approval Stats (Bar)</h5>
...
<script>
  ...
  new Chart(barCtx, {
    type: 'bar',
    data: {
      labels: ['Timesheets', 'Leave', 'Claims'],
      datasets: [
        { label: 'Pending', data: [6, 4, 2], backgroundColor: '#9A66ff' }
      ]
    },
  ...
  new Chart(pieCtx, {
    type: 'pie',
    data: {
      labels: ['Approved 60%', 'Rejected 10%', 'Pending 30%'],
      datasets: [{ data: [60, 10, 30], backgroundColor: ['#9A66ff', '#dc3545', '#ffc107'] }]
    },
