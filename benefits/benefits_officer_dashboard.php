...
$role = $_SESSION['role'] ?? 'benefits_officer';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Benefits Officer Dashboard - ViaHale TNVS HR3</title>
    ...
    <div class="main-content col" style="margin-left:220px;">
      ...
      <div class="stats-cards">
        ...
        <div class="stats-card">
          ...
          <div class="label">Processed Claims</div>
          <div class="value">27</div>
        </div>
        <div class="stats-card">
          <div class="icon"><ion-icon name="alert-circle-outline"></ion-icon></div>
          <div class="label">Flagged Claims</div>
      ...
      <div class="dashboard-col">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td>2025-08-28</td>
              <td>Benefits Officer</td>
              <td>Audit Performed</td>
              <td>Claims & Reimbursement</td>
...
<script>
  ...
  new Chart(barCtx, {
    ...
    data: {
      ...
      datasets: [
        { label: 'Claims', data: [8, 27, 3, 1], backgroundColor: ['#9A66ff','#4311a5','#dc3545','#ffc107'] }
      ]
    },
  ...
  new Chart(pieCtx, {
    type: 'pie',
    data: {
      labels: ['Approved 65%', 'Rejected 7%', 'Pending 28%'],
      datasets: [{ data: [65, 7, 28], backgroundColor: ['#9A66ff', '#dc3545', '#ffc107'] }]
    },
